...
import com.app.manoranjan.databinding.ActivityMovieDetailsBinding;
import com.app.manoranjan.dialogs.LargeImageDialog;
...
public class MovieDetailsActivity extends AppCompatActivity implements ApiResponseInterface {
    ...
    private void setFragmentsInViewPager() {
        ...
        movieDetailsPagerAdapter = new MovieDetailsPagerAdapter(this, fragmentOverviewBundle, fragmentStarCastBundle, 3);
    ...
    private void setImages() {
        //poster image
        binding.posterImg.startAnimation(Helper.getAlphaAnimation(1000));
    ...
    private void setData() {
        ...
        binding.movieTitle.startAnimation(Helper.getAlphaAnimation500());
        binding.releaseYear.startAnimation(Helper.getAlphaAnimation500());
        binding.genres.startAnimation(Helper.getAlphaAnimation500());
        binding.countryCode.startAnimation(Helper.getAlphaAnimation500());
        binding.runningTime.startAnimation(Helper.getAlphaAnimation500());
        binding.userScore.startAnimation(Helper.getAlphaAnimation500());
        binding.txtUserScore.startAnimation(Helper.getAlphaAnimation500());
        binding.markAsFav.startAnimation(Helper.getAlphaAnimation500());
        binding.addToWatchlist.startAnimation(Helper.getAlphaAnimation500());
        binding.rateIt.startAnimation(Helper.getAlphaAnimation500());
        binding.tagLine.startAnimation(Helper.getAlphaAnimation500());
